	...
	class PieReg_Base extends PieRegisterBaseVariables
	{
		...
		*/
		...
		function install_settings()
		{
			...
			{
				$piereg_login 		= $piereg_registrtion = $piereg_forgot_pass = $piereg_profile = "null";
			}
			
			$pie_pages = get_option("pie_pages");
			
			if(trim($piereg_login) === false )//Login
			{
				$_p = array();
			...
			if(trim($piereg_registrtion) === false )//Registration
			{
				$_p = array();
			...
			if(trim($piereg_forgot_pass) === false )//Forgot Password
			{
				$_p = array();
			...
			if(trim($piereg_profile) === false )//Profile Page
			{
				$_p = array();
