jQuery(document).ready(function(){
	...
	if (jQuery(".attachment").length) {
		...
		jQuery('a.pie-btn-download-all-user-documents').click(function() {
			...
			jQuery('body').Wload({text:' Loading'});
			...
			jQuery.ajax({
				...
				{
					jQuery('body').Wload('hide',{time:1000});
...
jQuery(document).ready(function(){
	...
	jQuery('.notification-item .notification-item-toggler').click(function(){
		...
		// jQuery(this).siblings('.content').find('li').slideToggle();
		jQuery(this).toggleClass('active');
		jQuery(this).parents('.notification-item').siblings().find('.content').slideUp();
		// jQuery(this).parents('.notification-item').siblings().find('.content').find('li').slideUp();
