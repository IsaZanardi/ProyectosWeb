...
Create custom user registration forms, drag & drop form builder, send invitation codes, add conditional logic, 2-step authentication, assign user roles, accept payments and more!

== Description ==
Pie Register is a WordPress Registration Plugin to build customized user registration forms. 
It has easy to use features like drag and drop form builder, invitation-only registration, email templates, conditional logic, data import & export, role-based redirection, and a payment gateway, so you charge for your membership-base site. Check out the full list of features below.

Pie Register comes in two versions, community and professional. The community version is free. The plugin community and developers support it via the support forum. The PRO version has additional features and comes with ticket-based support.

[youtube https://www.youtube.com/watch?v=CTL1pmd4uZA]

Pie Register PRO offers perpetual licensing – get once and use for a lifetime, no hassles or recurring payments. [Upgrade Now](https://pieregister.com/plan-and-pricing/?utm_source=plugin-freeversion&utm_medium=gopropage&utm_campaign=go_pro)
...
Easy to embed shortcodes make it possible to showcase your form in Page, Post, sidebar widgets, and more.
...
Use the robust open-source community support Forum, or our helpful How-to videos that are short and to the point.

= Documentation: =
[https://pieregister.com](https://pieregister.com)
Visit the [documentation page](https://pieregister.com/manual/introduction/) or download the PDF [here](https://pieregister.com/wp-content/uploads/2018/05/Pie-Register-Version-3-Product-Manual.pdf).
...
[Upgrade to WordPress Registration Plugin Pro Version](https://pieregister.com/plan-and-pricing/?utm_source=plugin-freeversion&utm_medium=gopropage&utm_campaign=go_pro)

= PREMIUM ADD-ONS (FREE WITH PRO): =
...
More Addons details, click here: [https://pieregister.com/addons](https://pieregister.com/addons/?utm_source=plugin-freeversion&utm_medium=gopropage&utm_campaign=go_pro&utm_content=addons)
...
== CHANGELOG ==
### 3.3.3
* Fixed: Empty Inivitation codes grid.
* Fixed: Not inserting inivitation codes.
...
3. Payment Gateways
4. Settings
5. Attachments (Avaialable in PRO)
6. Invitation Codes
7. Invitation Codes - Auto Generate Codes (Avaialable in PRO)
8. Invitation Codes - Invite through email (Avaialable in PRO)
9. Block Users (Avaialable in PRO)
10. Import/Export