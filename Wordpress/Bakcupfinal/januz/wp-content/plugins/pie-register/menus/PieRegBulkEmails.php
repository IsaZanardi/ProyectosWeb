...
<div id="bulkemails_tabs" class="hideBorder">
	<div class="settings">
        ...
        <div class="tabOverwrite">
            <div id="tabsSetting" class="tabsSetting">            
                <ul class="tabLayer1">
                    ...
                    { ?>
                        <li><a href="#piereg_aweber"><?php _e("Aweber","pie-register")?></a></li>
                    <?php 
                    } 
					else if( !file_exists( dirname(dirname(dirname(__FILE__))) . "\pie-register-aweber\pie-register-aweber.php" ) )
					{
						...
						?>
                    		<li><a href="#piereg_aweber"><?php _e("Aweber (Coming Soon)","pie-register")?></a></li>
                    	<?php 
					}  
					?>
                </ul>
