  ...
  <ul class="bg-white clearfix invite-form">
      ...
      <li class="clearfix">
        <div class="fields">
         ...
         <div class="cols-3">          
          <textarea name="pie_email_content" id="pie_email_content" class="ckeditor" <?php echo $_disable; ?>><?php echo (isset($piereg['pie_email_content'])?$piereg['pie_email_content']:''); ?></textarea>  
          <br/>  
