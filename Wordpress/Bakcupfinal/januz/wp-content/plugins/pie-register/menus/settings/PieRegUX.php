...
<?php } else { ?>	
    ...
    <div class="fields">
        ...
        <input id="pie_custom_logo_url" type="text" name="custom_logo_url" value="<?php echo $piereg['custom_logo_url'];?>" placeholder="<?php _e("Please enter Logo URL","pie-register"); ?>" class="input_fields" style="width:43%;" />
